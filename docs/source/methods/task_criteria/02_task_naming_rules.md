...
- [Pseudo tasks](01_task_selection_criteria.md#task-criteria-1-3) keep the suffix too ("Rest Task", "Fixate Task", "Take Questionnaire Task", "Receive Feedback Task"), so that every Catalog entry is named the same way
