...
Tendency to engage with stimuli associated with positive outcomes.

**Tasks that engage this process:** [Affective Picture Viewing Task](../tasks/hedtsk_affective_picture_viewing.md), [Balloon Analog Risk Task](../tasks/hedtsk_balloon_analog_risk.md), [Effort-Based Decision-Making Task](../tasks/hedtsk_effort_based_decision_making.md), [Iowa Gambling Task](../tasks/hedtsk_iowa_gambling.md), [Monetary Incentive Delay Task](../tasks/hedtsk_monetary_incentive_delay.md), [Probabilistic Selection Task](../tasks/hedtsk_probabilistic_selection.md), [Social Incentive Delay Task](../tasks/hedtsk_social_incentive_delay.md)
...
Tendency to disengage from stimuli associated with negative outcomes.

**Tasks that engage this process:** [Affective Picture Viewing Task](../tasks/hedtsk_affective_picture_viewing.md), [Pavlovian Fear Conditioning Task](../tasks/hedtsk_pavlovian_fear_conditioning.md), [Probabilistic Selection Task](../tasks/hedtsk_probabilistic_selection.md)
...
Decision to expend physical or cognitive effort as a function of expected reward and cost.

**Tasks that engage this process:** [Effort-Based Decision-Making Task](../tasks/hedtsk_effort_based_decision_making.md)
...
"Wanting" attributed to reward-predictive cues, distinct from "liking."

**Tasks that engage this process:** [Monetary Incentive Delay Task](../tasks/hedtsk_monetary_incentive_delay.md), [Social Incentive Delay Task](../tasks/hedtsk_social_incentive_delay.md)
...
Affective and neural response to cues predicting upcoming reward.

**Tasks that engage this process:** [Balloon Analog Risk Task](../tasks/hedtsk_balloon_analog_risk.md), [Effort-Based Decision-Making Task](../tasks/hedtsk_effort_based_decision_making.md), [Monetary Incentive Delay Task](../tasks/hedtsk_monetary_incentive_delay.md), [Social Incentive Delay Task](../tasks/hedtsk_social_incentive_delay.md)
