...
| Narrative pages: landing, introduction, how to use, the Atlas essays, the Methods documents | `docs/source/*.md`, `docs/source/atlas/what_is_in_the_cognitive_atlas.md`, `docs/source/atlas/the_catalog_vs_the_atlas.md`, `docs/source/methods/**` | Edited here by pull request, directly in Markdown                                        |
...
| Generated catalog pages                                                                     | `docs/source/tasks/`, `processes/`, `task_process_links.md`, `atlas/*_mapping_tables.md`, `_generated/`                                              | Never by hand; regenerated and committed                                                 |
